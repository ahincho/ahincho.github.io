...
- **Dependencies**: always target the latest stable version — GitHub Actions included; never leave an action on a deprecated major. Dependabot (`.github/dependabot.yml`) opens weekly PRs for actions, the site and `worker/`.
